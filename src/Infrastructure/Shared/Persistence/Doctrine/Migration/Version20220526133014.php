 ...
 */
final class Version20220526133014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id BINARY(36) NOT NULL COMMENT \'(DC2Type:user_id)\', name VARCHAR(2000) NOT NULL COMMENT \'(DC2Type:name)\', lastname VARCHAR(2000) NOT NULL COMMENT \'(DC2Type:lastname)\', creation_date DATETIME NOT NULL COMMENT \'(DC2Type:creation_date)\', email VARCHAR(70) NOT NULL COMMENT \'(DC2Type:email)\', password VARCHAR(255) NOT NULL, password_recovery_salt VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
