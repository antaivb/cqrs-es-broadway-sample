...
final class NumBookingsType extends Type
{
    const NAME = 'numBookings';

    protected function getUidClass(): string
    {
        return NumBookings::class;
    }
     ...
     */
    public function convertToPHPValue($value, AbstractPlatform $platform) : ?NumBookings
    {
        return $value !== null ? NumBookings::fromInt((int)$value) : null;
    }
     ...
     *
     * @param NumBookings|null $value The value to convert.
     */
